...
mkdir -p /home/wgy/RL/eval_results

cd /home/wgy/RL || exit 1
...
# Inside this process: cuda:0->4, cuda:1->5, cuda:2->6, cuda:3->7.
export CUDA_VISIBLE_DEVICES="${CUDA_VISIBLE_DEVICES:-4,5,6,7}"
export RL_GPU_IDS="${RL_GPU_IDS:-3}"
export DINO_DEVICE="${DINO_DEVICE:-cuda:0}"
export DINO_DEVICES="${DINO_DEVICES:-cuda:0,cuda:1,cuda:2}"
export ENV_GPU_IDS="${ENV_GPU_IDS:-0,1,2}"
export WORKERS_PER_ENV_GPU="${WORKERS_PER_ENV_GPU:-4}"

DEFAULT_POLICY="/home/wgy/RL/components/data/model_weights/hm3d_viewpoint_imitation_features_transformer_poi4yaw_20260524_172033/hm3d_imitation_best_balanced.pth"
...
CSV_FILE="/home/wgy/RL/eval_results/${EXP_NAME}.csv"
...
CMD=(/root/miniconda3/envs/habitat/bin/python /home/wgy/RL/train_habitat_parallel.py
