...
def main(config):
    ...
    if args.use_habitat:
        ...
        env = HabitatEnv(
            ...
            visible_coverage_bonus_scale=env_config.get("visible_coverage_bonus_scale", 0.1),
            ...
            no_progress_window=env_config.get("no_progress_window", 100),
            no_progress_penalty=env_config.get("no_progress_penalty", 0.02),
            no_progress_min_coverage_delta=env_config.get("no_progress_min_coverage_delta", 1e-4),
            turn_penalty=env_config.get("turn_penalty", 0.0003),
            stationary_turn_window=env_config.get("stationary_turn_window", 20),
            stationary_turn_penalty=env_config.get("stationary_turn_penalty", 0.01),
            stationary_turn_min_distance=env_config.get("stationary_turn_min_distance", 0.02),
            stationary_turn_termination_window=env_config.get("stationary_turn_termination_window", 0),
            ...
            visible_coverage_stride=env_config.get("visible_coverage_stride", 32),
            visible_coverage_max_depth=env_config.get("visible_coverage_max_depth", 2.0),
            visible_coverage_min_ray_step=env_config.get("visible_coverage_min_ray_step", 0.25),
